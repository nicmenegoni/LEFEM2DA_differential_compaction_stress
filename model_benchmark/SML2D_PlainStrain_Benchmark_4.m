...
material=tnum;
consider_bodyforce = 1;
apply_distribforce = 0;
apply_nodalforce = 0;

%% Material parameters
E1 = 65e9;%GPa
nu1 = 0.33;
D1 = flexuralrigidity(E1, nu1,1);%Flexural rigidity or elasticity matrix
rho1=0.271e4;%Kg/m^3

%Material parameters
E2 = 65e9;%GPa
nu2 = 0.33;
D2 = flexuralrigidity(E2, nu2,1)%Flexural rigidity or elasticity matrix
rho2=0.271e4;%Kg/m^3

%Material parameters
E3 = 65e9;%GPa
nu3 = 0.33;
D3 = flexuralrigidity(E3, nu3,1)%Flexural rigidity or elasticity matrix
rho3=0.271e4;%Kg/m^3
...
[K,B] = stiffnessmatrix (t,p, material, D);
...
for nodes = 1 : size(vert, 1)
    ...
    if p(2, nodes) == 0  %Roller Boundary (blocked onto y)
        [K,F] = boundarycondition (node, K, F, 3)
    elseif p(1,nodes) == 0 || p(1,nodes) == 1500%Roller Boundary (blocked onto x)
        [K,F] = boundarycondition (node, K, F, 2)
    end
end
